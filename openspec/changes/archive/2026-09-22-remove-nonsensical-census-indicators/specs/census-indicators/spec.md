...
**Reason**: The current implementation exposes ethnicity/race, gender/sex, and age group as single numeric indicators rather than meaningful distributions or categories, which makes them misleading for map, chart, table, and popup use.
**Migration**: Remove literacy, ethnicity/race, gender/sex, and age group from the public indicator catalog and displayed indicator values. Reintroduce categorical indicators only through a future change that models their source categories explicitly.
